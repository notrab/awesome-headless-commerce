...
- [Unchained Engine](https://unchained.shop/unchained-engine) &mdash; Open-source headless e-commerce framework for Node.js: GraphQL API, TypeScript, MongoDB, built-in MCP server for AI agents.
